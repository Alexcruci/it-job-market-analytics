...
for job in jobs:
    ...
    # Retrieve the PostgreSQL-generated ID for the inserted job
...
# Validate the loaded data before committing the transaction
...
print("Job-skill relationships inserted:", job_skills_count)
